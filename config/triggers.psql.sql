...
CREATE TRIGGER accounts_log
AFTER INSERT OR UPDATE OR DELETE ON accounts
    FOR EACH ROW EXECUTE PROCEDURE log_row_change('accounts');

CREATE TRIGGER families_log
AFTER INSERT OR UPDATE OR DELETE ON families
    FOR EACH ROW EXECUTE PROCEDURE log_row_change('families');
